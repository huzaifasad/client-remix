                ...
                <Container fluid>
                    <Row className="auth-split">
                        ...
                        <Col xl={7} lg={6} md={5} sm={10} className="d-md-block d-none position-relative bg-primary-light-5">
                            ...
                            <p className="p-xs credit-text opacity-55">All illustration are powered by <Link to="https://icons8.com/ouch/" target="_blank" rel="noreferrer" className="text-light"><u>Icons8</u></Link></p>
                        </Col>
                    </Row>
                </Container>
            </div>
