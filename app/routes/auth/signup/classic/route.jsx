                                            ...
                                            <Card className="card-border">
                                                <Card.Body>
                                                    ...
                                                    <p className="p-xs mt-2 mb-4 text-center">
                                                        Already a member ? <Link to="/auth/login/classic"><u>Sign In</u></Link>
                                                    </p>
                                                    ...
                                                    <Button variant='primary' className="btn-rounded btn-uppercase btn-block" as={Link} to="/auth/login-classic" >Create account</Button>
                                                </Card.Body>
                                            </Card>
                                        </Col>
                                    </Row>
