...
import HkBadge from '~/@hk-components/@hk-badge/@hk-badge';
            ...
            <nav className="blogapp-sidebar">
                <SimpleBar className="nicescroll-bar">
                    <div className="menu-content-wrap">
                        <Link to="/apps/blog/add-new-post" className="btn btn-primary btn-rounded btn-block mb-4">
                            Create Post
                        </Link>
                        ...
                        <div className="menu-group">
                            <div className="tag-cloud">
                                <Link to="#" className="badge badge-outline badge-light">Collaboration</Link>
                                <Link to="#" className="badge badge-outline badge-light">React Developer</Link>
                                <Link to="#" className="badge badge-outline badge-light">Angular Developer</Link>
                                <Link to="#" className="badge badge-outline badge-light">promotion</Link>
                                <Link to="#" className="badge badge-outline badge-light">Advertisement</Link>
                            </div>
                        </div>
                    </div>
                </SimpleBar>
