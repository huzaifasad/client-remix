...
import HkAvatarUploader from '~/@hk-components/@hk-avatar-uploader/@hk-avatar-uploader';
            ...
            <Modal.Body className="p-0">
                <header className="contact-header">
                    ...
                    <div className="contact-options-wrap">
                        ...
                        <Link to="#" className="btn btn-icon btn-flush-dark btn-rounded flush-soft-hover contactapp-info-toggle  d-xl-inline-block d-none">
