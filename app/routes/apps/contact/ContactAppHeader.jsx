            ...
            <div className="contact-options-wrap">
                <Dropdown className="inline-block" >
                    ...
                    <Dropdown.Menu align="end">
                        <Dropdown.Item as={Link} to="/apps/contact/contact-list" className={classNames({ "active": contactListRoute })} ><span className="feather-icon dropdown-icon">
                            <List />
                        </span>
                            <span>List View</span>
                        </Dropdown.Item>
                        <Dropdown.Item as={Link} to="/apps/contact/contact-cards" className={classNames({ "active": pathname === "/apps/contact/cards" })}>
                            <span className="feather-icon dropdown-icon">
                                <Grid />
                            </span>
                            <span>Grid View</span>
