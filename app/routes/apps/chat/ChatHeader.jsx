    ...
    return (
        <>
            <header className="chat-header">
                <Button as="a" href="#" variant="flush-dark" size="sm" className="btn-icon btn-rounded flush-soft-hover back-user-list" onClick={BackToContactList} >
                    <span className="icon">
                    ...
                    <div className="media">
                        <div className="media-head">
                            <div className="avatar avatar-sm avatar-rounded position-relative">
                                {states.chatState.avatar.type === "img" && <img src={states.chatState.avatar.src} alt="user" className="avatar-img" />}
                ...
                {groupRoutes && <div className="media">
                    <div className="media-head">
                        <div className={states.chatState.grpAvatar.type === "img" ? "avatar avatar-sm position-relative avatar-rounded avatar-primary" : `avatar avatar-sm position-relative avatar-rounded avatar-${states.chatState.grpAvatar.variant}`}>
                            {states.chatState.grpAvatar.type === "img" && <img src={states.chatState.grpAvatar.src} alt="user" className="avatar-img" />}
