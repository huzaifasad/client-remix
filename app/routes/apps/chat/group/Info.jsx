            ...
            <SimpleBar className="nicescroll-bar">
                ...
                <div className="text-center">
                    {states.chatState.grpAvatar.type === "img" && <div className="avatar avatar-xxl avatar-rounded">
                        <img src={states.chatState.grpAvatar.src} alt="user" className="avatar-img" />
                    </div>}
                            ...
                            <div className="collapse-simple mt-3">
                                ...
                                >
                                    <ul className="hk-list">
                                        ...
                                        <li>
                                            <Link href="#" className="avatar avatar-sm avatar-icon avatar-soft-light avatar-rounded" onClick={invitePeople} >
