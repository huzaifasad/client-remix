        ...
        <>
            <div className="chatapp-aside">
                <header className="aside-header">
                    <Dropdown>
                        <Dropdown.Toggle as={Link} to="#" className="chatapp-title link-dark" >
                            <h1>Chat</h1>
                        </Dropdown.Toggle>
                        <Dropdown.Menu>
                            <Dropdown.Item as={Link} to="/apps/chat/chats">
                                <span className="feather-icon dropdown-icon">
                                    <Icons.MessageSquare />
                                </span>
                                <span>Chats</span>
                            </Dropdown.Item>
                            <Dropdown.Item as={Link} to="/apps/chat/contact">
                                <span className="feather-icon dropdown-icon">
                                    <Icons.Book />
                                </span>
                                <span>Contacts</span>
                            </Dropdown.Item>
                            <Dropdown.Item as={Link} to="/apps/chat/group">
                                <span className="feather-icon dropdown-icon">
                                    <Icons.User />
                                </span>
                                <span>Groups</span>
                    ...
                    <div className="d-flex">
                        ...
                        <Link className="btn btn-icon btn-rounded btn-primary" onClick={invitePeople} >
                            <span className="icon">
                                <span className="feather-icon">
                                    <Icons.Plus />
                                </span>
                                    ...
                                    <div className={classNames("media", { "active-user": elem.id === states.chatState.userId }, { "read-chat": !elem.unread })}>
                                        <div className="media-head">
                                            {elem.avatar && <div className="avatar avatar-sm avatar-rounded position-relative">
                                                <img src={elem.avatar.src} alt="user" className="avatar-img" />
                                        ...
                                        <div className="media-body">
                                            ...
                                            <div>
                                                ...
                                                <div className="dropdown action-drp">
                                                    <Link href="#" className="btn btn-icon btn-flush-dark btn-rounded flush-soft-hover dropdown-toggle no-caret" data-bs-toggle="dropdown"><span className="icon"><span className="feather-icon"><i data-feather="more-horizontal" /></span></span></Link>
                                                    <div className="dropdown-menu dropdown-menu-end">
                                                        <Link className="dropdown-item" href="#">Mute Chat</Link>
                                                        <Link className="dropdown-item" href="#">Archive Chat</Link>
                                                        <Link className="dropdown-item" href="#">Delete Chat</Link>
                                                        <Link className="dropdown-item link-danger" href="#">Block</Link>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
