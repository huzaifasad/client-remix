            ...
            <SimpleBar style={{ height: "100%" }} className="nicescroll-bar">
                ...
                <div className="text-center">
                    {states.chatState.avatar.type === "img" && <div className="avatar avatar-xxl avatar-rounded">
                        <img src={states.chatState.avatar.src} alt="user" className="avatar-img" />
                    </div>}
                        ...
                        <Tab.Pane eventKey="info" >
                            ...
                            <div className="collapse-simple mt-3">
                                ...
                                >
                                    ...
                                    <Link href="#" className="d-block text-dark fs-7 mb-10">Give feedback and report conversation</Link>
                                </HkCollapse>
                            </div>
                        </Tab.Pane>
