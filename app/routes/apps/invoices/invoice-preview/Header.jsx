    ...
    return (
        <header className="invoice-header">
            <div className="d-flex align-items-center">
                <Button as={Link} to="/apps/invoices/create-invoice" variant="flush-dark" className="btn-icon btn-rounded flush-soft-hover">
                    <span className="icon">
            ...
            <div className="invoice-options-wrap">
                <Button variant="soft-primary" as={Link} to="/apps/invoices/create-invoice" className="flex-shrink-0 d-md-inline-block d-none">Start with Template</Button>
