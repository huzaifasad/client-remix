...
import HkSimpleCollapse from '~/@hk-components/@hk-collapse/@hk-simple-collapse';
                        ...
                        <div className="create-invoice-wrap mt-xxl-5 p-md-5 p-3">
                                ...
                                <Col xxl={4} className="offset-xxl-5 mt-xxl-0 mt-6">
                                    <Form>
                                        ...
                                        <div className="repeater">
                                            ...
                                            <Link to="#" data-repeater-create className="d-inline-flex align-items-center">
                            ...
                            <div className="table-wrap mt-5">
                                <div className="invoice-table-wrap">
                                    ...
                                    <Link to="#" className="d-inline-flex align-items-center add-new-row" onClick={addItem} >
                            ...
                            <div className="repeater">
                                ...
                                <Link to="#" className="d-inline-flex align-items-center" onClick={addNewConditon}>
