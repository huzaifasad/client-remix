    ...
    return (
        <header className="invoice-header">
            ...
            <div className="invoice-options-wrap">
                <Button variant="flush-dark" className="btn-icon btn-rounded flush-soft-hover invoiceapp-setting-toggle active me-2" onClick={handleSettings} >
                    <span className="icon">
                ...
                <Button as={Link} to="/apps/invoices/invoice-preview" variant="outline-secondary" className="flex-shrink-0 d-md-inline-block d-none">Preview</Button>
                <Button as={Link} to="#" variant="primary" className="mx-2 d-sm-inline-block d-none">save</Button>
