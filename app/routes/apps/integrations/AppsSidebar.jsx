                ...
                <div className="menu-content-wrap">
                    ...
                    <div className="menu-group">
                        <Nav as="ul" className="nav-light navbar-nav flex-column">
                            <Nav.Item as="li">
                                <Nav.Link as={Link} to="/apps/integrations/integration" className={pathname === "/apps/integrations/integration" ? "active" : ""} >
                    ...
                    <div className="menu-group">
                        <Nav as="ul" className="nav-light navbar-nav flex-column">
                            <Nav.Item as="li">
                                <Nav.Link as={Link} to="/apps/integrations/all-apps" className={pathname === "/apps/integrations/all-apps" ? "active" : ""} >
                                    <span className="nav-icon-wrap">
                                        <span className="feather-icon">
                                            <Grid />
                                        </span>
                            ...
                            <Nav.Item as="li">
                                <Nav.Link as={Link} to="/apps/integrations/app-detail" className={pathname === "/apps/integrations/app-detail" ? "active" : ""} >
                                    <span className="nav-icon-wrap">
                                        <span className="feather-icon">
                                            <Zap />
                                        </span>
