                            ...
                            <Row className="gx-3 row-cols-xxl-6 row-cols-xl-4 row-cols-lg-3 row-cols-md-2 row-cols-1 mt-3">
                                <Col>
                                    <Card className="file-card card-border">
                                        <Card.Body className="fmapp-info-trigger" onClick={() => dispatch({ type: "show_fmInfo", showInfo: true })}>
                                ...
                                <Col>
                                    <Card className="file-compact-card card-border">
                                        <Card.Body className=" d-flex justify-content-between">
                                            <div className="media fmapp-info-trigger" onClick={() => dispatch({ type: "show_fmInfo", showInfo: true })}>
                                ...
                                <Col>
                                    <Card className="file-compact-card card-border">
                                        <Card.Body className=" d-flex justify-content-between">
                                            <div className="media fmapp-info-trigger" onClick={() => dispatch({ type: "show_fmInfo", showInfo: true })}>
                                                <div className="media-head me-3">
                                                    <img src={mock7} alt="user" className="d-block img-fluid h-50p w-75p" />
                                                </div>
                                                <div className="media-body">
                                ...
                                <Col>
                                    <Card className="file-compact-card card-border">
                                        <Card.Body className=" d-flex justify-content-between">
                                            <div className="media fmapp-info-trigger" onClick={() => dispatch({ type: "show_fmInfo", showInfo: true })}>
                                                <div className="media-head me-3">
                                                    <img src={mock5} alt="user" className="d-block img-fluid h-50p w-40p" />
                                                </div>
                                                <div className="media-body">
